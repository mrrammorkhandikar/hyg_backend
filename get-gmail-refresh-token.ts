#!/usr/bin/env node
/**
 * One-Click Gmail OAuth Script
 *
 * This script:
 * 1. Opens the Google OAuth consent screen in the browser
 * 2. Requests scope: https://www.googleapis.com/auth/gmail.send
 * 3. Uses access_type=offline and prompt=consent
 * 4. Automatically receives the OAuth callback on localhost
 * 5. Exchanges the authorization code for tokens
 * 6. Prints ONLY the refresh_token clearly in the console
 * 7. Saves the refresh_token into a .env file as GMAIL_REFRESH_TOKEN
 *
 * Usage: node get-gmail-refresh-token.ts
 */
